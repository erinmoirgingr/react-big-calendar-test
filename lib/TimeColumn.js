...
var TimeColumn = function (_Component) {
  ...
  TimeColumn.prototype.render = function render() {
    ...
    if (this.props.view === 'day') {
      if (this.props.extraColumnSlots > 0) {
        for (var i = 0; i < this.props.extraColumnSlots; i++) {
          timeslots.push(_react2.default.createElement(
            'div',
            { key: "time-gutter-extra-slot-" + i, className: (0, _classnames2.default)('rbc-time-slot specialist-time-slot' + (i === 0 ? ' rbc-day-column-pk-name' : '')) },
            i === 0 ? 'Slots' : ' '
          ));
        };
      }
      ...
      timeslots.push(_react2.default.createElement(
        'div',
        { key: 'time-gutter-person', className: (0, _classnames2.default)('rbc-time-slot time-gutter-person') },
        ' '
      ));
    }
