  ...
  _createClass(Popup, [{
    ...
    value: function componentDidMount() {
      var _this$props$popupOffs = this.props.popupOffset,
          ...
          _offset = (0, _offset2["default"])(this.refElems.root.current),
          top = _offset.top,
          left = _offset.left,
          width = _offset.width,
    ...
    value: function render() {
      ...
      }, _localizer["default"].format(props.slotStart, props.dayHeaderFormat, props.culture)), events && events.map(function (event, idx) {
