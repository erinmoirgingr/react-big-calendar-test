...
var getChildGroups = function getChildGroups(idx, nextIdx, _ref5) {
  ...
  var endAccessor = _ref5.endAccessor;
  var min = _ref5.min;
  var totalMin = _ref5.totalMin;
...
var getYStyles = function getYStyles(idx, _ref6) {
  ...
  var startAccessor = _ref6.startAccessor;
  var endAccessor = _ref6.endAccessor;
  var min = _ref6.min;
  var totalMin = _ref6.totalMin;
  var step = _ref6.step;
...
function getStyledEvents(_ref7) {
  ...
  var startAccessor = _ref7.startAccessor;
  var endAccessor = _ref7.endAccessor;
  var min = _ref7.min;
  var totalMin = _ref7.totalMin;
  var step = _ref7.step;
  ...
  var _loop = function _loop() {
    ...
    var childGroups = _getChildGroups.childGroups;
    var nbrOfChildColumns = _getChildGroups.nbrOfChildColumns;
    ...
    [idx].concat(siblings).forEach(function (eventIdx, siblingIdx) {
      ...
      var top = _getYStyles.top;
      var height = _getYStyles.height;
    ...
    childGroups.forEach(function (group) {
      ...
      group.forEach(function (eventIdx, i) {
        ...
        var top = _getYStyles2.top;
        var height = _getYStyles2.height;
