  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        _extends({}, props, {
          style: _extends({}, props.style, style, { backgroundColor: this.props.event.color || 'inherit' }),
        ...
        _react2.default.createElement(
          'div',
          { className: 'rbc-event-content', title: title.replace(/<\/?[^>]+(>|$)/g, "") },
          Event ? _react2.default.createElement(Event, { event: event, title: title.replace(/<\/?[^>]+(>|$)/g, "") }) : _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: title } })
        )
      )
    );
  }
